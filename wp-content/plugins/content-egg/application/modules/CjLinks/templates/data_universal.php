                ...
                <div class="row-products">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 offer_price cegg-price-cell">
                        ...
                        <div class="cegg-btn-row cegg-mb10">
                            <a<?php TemplateHelper::printRel(); ?> target="_blank" title="<?php echo esc_attr($item['extra']['advertiserSite']); ?>" href="<?php echo $item['url']; ?>" class="btn btn-success"><?php TemplateHelper::couponBtnText(true, $item, $btn_text); ?></a>
                        </div> 
