...
register_block_pattern(
    'rehubtheme/carttitleblock',
    array(
        'title'       => __( 'Cart page title block', 'rehub-framework' ),
        'categories' => array('rehubaff'),
        'description' => _x( 'Title block for cart or other system pages with back link button', 'Block pattern description', 'rehub-framework' ),
        'content'     => '<!-- wp:cover {"minHeight":100,"minHeightUnit":"px","customGradient":"linear-gradient(135deg,rgb(247,247,247) 0%,rgb(251,253,255) 100%)","contentPosition":"center center","align":"full","className":"pr30 pl30 roundborder8"} -->
        <div class="wp-block-cover alignfull has-background-dim has-background-gradient pr30 pl30 roundborder8" style="background:linear-gradient(135deg,rgb(247,247,247) 0%,rgb(251,253,255) 100%);min-height:100px"><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","className":"mb0 mt0"} -->
        <div class="wp-block-columns are-vertically-aligned-center mb0 mt0"><!-- wp:column {"verticalAlignment":"center","className":"mobileblockdisplay"} -->
        <div class="wp-block-column is-vertically-aligned-center mobileblockdisplay"><!-- wp:heading {"textAlign":"left","level":1,"style":{"typography":{"lineHeight":"1.5","fontSize":25}},"textColor":"black","className":"mb0 mt0"} -->
        <h1 class="has-text-align-left mb0 mt0 has-black-color has-text-color" style="font-size:25px;line-height:1.5">Shopping Cart</h1>
        <!-- /wp:heading --></div>
        <!-- /wp:column -->
        
        <!-- wp:column {"verticalAlignment":"center","className":"mobileblockdisplay"} -->
        <div class="wp-block-column is-vertically-aligned-center mobileblockdisplay"><!-- wp:paragraph {"align":"right","className":"mb0 mt0 disablemobilealign"} -->
        <p class="has-text-align-right mb0 mt0 disablemobilealign"><a href="/shop" data-type="URL" data-id="/shop">Return to shop →</a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div></div>
        <!-- /wp:cover -->
