...
<input type="text" class="input-sm col-md-4" ng-model="query_params.<?php echo $module_id; ?>.price_min" ng-init="query_params.<?php echo $module_id; ?>.price_min = ''" placeholder="<?php _e('Min. price', 'content-egg'); ?>" />
